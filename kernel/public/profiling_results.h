...
@code
    - Semaphore Initialization: 72 cycles (averaged over 41 iterations)
    - Semaphore Post (uncontested): 183 cycles (averaged over 41 iterations)
    - Semaphore Pend (uncontested): 90 cycles (averaged over 41 iterations)
    - Semaphore Flyback Time (Contested Pend): 2376 cycles (averaged over 41 iterations)
    - Mutex Init: 498 cycles (averaged over 41 iterations)
    - Mutex Claim: 200 cycles (averaged over 41 iterations)
    - Mutex Release: 128 cycles (averaged over 41 iterations)
    - Thread Initialize: 10791 cycles (averaged over 41 iterations)
    - Thread Start: 1174 cycles (averaged over 41 iterations)
    - Context Switch: 203 cycles (averaged over 41 iterations)
    - Thread Schedule: 94 cycles (averaged over 40 iterations)
@endcode
*/
